...
type alias LoadingData =
    ...
    , sessionName : Evergreen.V2.SessionName.SessionName
    }
...
type alias LoadedData =
    ...
    , copyCounter : Int
    , elmUiState : Evergreen.V2.Ui.Anim.State
    , settings : Settings
...
type alias BackendModel =
    { sessions : AssocList.Dict Evergreen.V2.SessionName.SessionName Session
    }
...
type FrontendMsg
    ...
    | UrlChanged Url.Url
    | PressedResetSession
    | GotRandomSessionName Evergreen.V2.SessionName.SessionName
    | ScrolledToBottom
    | MouseDownOnEvent Int Bool
    | MouseEnterOnEvent Int Bool
    | ElmUiMsg Evergreen.V2.Ui.Anim.Msg
...
type ToBackend
    = LoadSessionRequest Evergreen.V2.SessionName.SessionName
    | ResetSessionRequest
