...
type alias LoadingData =
    ...
    , sessionName : Evergreen.V4.SessionName.SessionName
    }
...
type alias BackendModel =
    { sessions : AssocList.Dict Evergreen.V4.SessionName.SessionName Session
    }
...
type FrontendMsg
    ...
    | UrlChanged Url.Url
    | PressedResetSession
    | GotRandomSessionName Evergreen.V4.SessionName.SessionName
    | ScrolledToBottom
...
type ToBackend
    = LoadSessionRequest Evergreen.V4.SessionName.SessionName
    | ResetSessionRequest
